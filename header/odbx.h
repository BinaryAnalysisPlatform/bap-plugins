...
void* _ZN7OpenDBX4Conn6createERKSsNS_4Stmt4TypeE(const char* sql, int type);
...
void* _ZNSs6appendERKSs(const void* str);

// string& std::string::append(char const*, unsigned int)
void* _ZNSs6appendEPKcj(char const*, unsigned int);
